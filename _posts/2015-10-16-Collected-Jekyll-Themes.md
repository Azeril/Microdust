...
以 GitHub Pages 为基石的博客生态系统，容纳了 Jekyll、x、x、等为数不少的开源博客模板。而其中应用最广泛的还是 Jekyll。自打将博客迁移到基于 Jekyll 的主题后，也是几经辗转才稳定下来。

开源，意味着开放自主，也意味着自由的代价，控制不好就引发混乱，或各类由于信息不对称导致的问题。在不断探索更为适合自己的博客样式这一过程中，中间踩了好多的坑。回头看，也主要是这样几类：
